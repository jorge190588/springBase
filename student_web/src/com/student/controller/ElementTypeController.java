...
import com.student.ws.ElementTypeRestClient;

@SuppressWarnings({"rawtypes","unchecked"})
@Controller
@RequestMapping("/elementType")
public class ElementTypeController  <T>{
	private ElementTypeRestClient restClient = new ElementTypeRestClient();
	private ElementRestClient elementRestClient = new ElementRestClient();
	private static String moduleName="elementType";
	...
	public String index(ModelMap modelMap) {
		...
		modelMap.put("pageTitle", "Element Type page");
