...
public class FormController<T> {
	private FormRestClient restClient = new FormRestClient();
	...
	public String index(ModelMap modelMap) {
		...
		modelMap.put("pageTitle", "Form page");
	...
	public String create(@RequestParam("params") String params) {
	    try {
            Form newElement= mapper.readValue(params, Form.class);
	...
	public  String update(@RequestParam("params") String params) {
		try{
			Form updateElement= mapper.readValue(params, Form.class);
