...
import com.student.ws.EntitiRestClient;

@SuppressWarnings({"rawtypes","unchecked"})
@Controller
@RequestMapping("/entiti")
public class EntitiController <T>{
	private EntitiRestClient restClient = new EntitiRestClient();
	private ElementRestClient elementRestClient = new ElementRestClient();
	private static String moduleName="entiti";
	...
	public String index(ModelMap modelMap) {
		...
		modelMap.put("pageTitle", "Entiti page");
